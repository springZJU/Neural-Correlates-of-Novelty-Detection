ROOTPATH = "\\10.49.14.99\Monkey2\gym";
...
SAVEPATH = "H:\Neural correlates of novelty detection in the macaque primary auditory cortex\Data\OriginData\BehaviorOnly\Monica";
...
DATE = string(regexpi(TANKPATH, "20\d*gym", "match"));
